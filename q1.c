...
int main(int argc, char **argv)
{
    ...
    char outFileAddress[50] = "./Assignment/1_";
    ...
    int prefSize = inputFileLength/500;
    int chunkSize = (prefSize == 0) ? 1 : prefSize;
    int startingChunk = ((inputFileLength - 1) / chunkSize) * chunkSize;
    int readLength = inputFileLength - startingChunk;
